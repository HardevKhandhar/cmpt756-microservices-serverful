...
app.use(bodyParser.json());
    ...
    // connection string
    const uri = 'mongodb+srv://Rithik:123456abc@cluster0.x7lwnt0.mongodb.net/?retryWrites=true&w=majority';
...
app.get("/Rooms" , (req,res) => {
    ...
    app.delete("/rooms/:id" , (req,res) =>{
        room_Model.findByIdAndDelete(req.params.id).then(() => {
    ...
    app.post("/roomsupdate/:id/:status" , (req,res) =>{
        room_Model.updateOne({ _id: req.params.id }, { status: req.params.status }).then(() =>{
